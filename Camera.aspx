...
<body>
       <table cellpadding="0" cellspacing="0" width="100%">
        <tr><td height="25px" width="100%">&nbsp;</td></tr>
        <tr>
            <td width="100%">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center">
                                    ...
                                    <div class="auto-style1">
                                        ...
                                        <div style="width:640px; height:44px; text-align:center;background-color:#FFFFFF;">
                                            <div style=" float:left; margin:8px 10px 7px 20px">
                                                <a href="http://www.evercam.com/" target="_blank"><img height="25" src="http://www.evercam.io/img/logo.svg" border="0" width="175" alt="http://www.evercam.com/" /></a>

                                            </div>
                                            <div style="width: 143px; height: 25px; float: left; margin: 11px 10px 9px 270px; ">
                                                <a href="http://www.camba.tv" target="_blank"><img height="25" src="../../Images/cambasmall.gif" width="143" border="0" alt="http://www.camba.tv" /></a>
                                            </div>
                            ...
                            <div id="divComments" style="width:640px; text-align:center;  margin:auto;display:none;">
                                <div id="fb-root"></div>
                                <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.remembrancecam.com/" num_posts="2" width="640"></fb:comments>
                            </div>
                                        ...
                                        <td style="width:380px; text-align:right;" valign="top">
                                            <div style="padding:1px;">
                                                <iframe width="300" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
                                                        src="https://mapsengine.google.com/map/embed?mid=zVK_XsZ9U8JQ.k7gXFo9LSEvk"></iframe><br /><small>
